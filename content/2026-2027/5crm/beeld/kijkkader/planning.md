...
3. **Uitleg opnameapparatuur & camera-instellingen:**
   * Bedienen van de digitale spiegelreflex- en systeemcamera's van de school (focuspunten, belichtingsdriehoek, ontspanknop).
4. **Praktijkshoot op de schoolcampus:**
   * Zelfstandig op zoek naar composities in en rond het schoolgebouw.
...
2. **Beeldanalyse & culling in Adobe Bridge:**
   * Navigeren door de miniaturen, gebruik van de spatiebalk voor schermvullende inspectie.
   * EXIF-metadata analyseren (sluitertijd, diafragma, ISO).
   * Sterrenbeoordeling (`Ctrl + 1-5`) en kleurlabels toekennen om de drie allersterkste beelden te selecteren.
3. **Photoshop-workflow: Digitale bewerking:**
   * Uitsnijden met de **Crop Tool (`C`)**: oorspronkelijke beeldverhouding (*Original Ratio*) behouden, optie *Delete Cropped Pixels* uitschakelen, regel van derden overlay als richtlijn gebruiken.
   * **Camera Raw-filter (`Ctrl + Shift + A`)**: witbalans kalibreren, doortekening in hooglichten en schaduwen herstellen, lokaal contrast toevoegen via *Clarity* en *Dehaze*.
...
1. **Instructie: Opzet van het drieluik op A4:**
   ...
   * De drie bewerkte foto's importeren en harmonieus uitlijnen binnen de kaders.
   * Typografische bijschriften toevoegen onder elk paneel: compositieregel en fotografische parameters in een strakke sans-serif.
2. **Optionele integratie met 5CRM Motion (Compositie 4):**
   * Toelichting: in het vak Motion (opdracht *Vormen*) hebben leerlingen een contrastrijke 1:1 achtergrond nodig voor After Effects.
   * Wie wil kan een geschikt beeld uit de serie met de Crop Tool bijsnijden naar 1080 × 1080 px en exporteren als `02_exports/VoornaamA_Motion-Achtergrond.jpg`.
3. **Export & kwaliteitscontrole:**
   * Drieluik exporteren als hoogwaardige JPEG naar `02_exports/VoornaamA_Kijkkader-Drieluik.jpg`.
   * Zelfevaluatie aan de hand van de kwaliteitschecklist op de website.
4. **Finale inlevering:**
