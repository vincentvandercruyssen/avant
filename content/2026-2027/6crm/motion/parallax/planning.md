...
**Vakken:** Motion (dinsdag & vrijdag) & Beeld (maandag) (6CRM)  
**Lokalen:** A00.39 (Motion) / A00.32 (Beeld)  
**Totale duurtijd:** 6 lesmomenten (Motion + Beeld integratie)  
**Periode:** September 2026  

## 📅 Les 1 01/09/2026 (2x Motion)

### 📌 Titel lesfiche
> **Motion 6CRM: Kennismaking & Briefing Parallax-animatie**
...
Welkom in 6CRM Motion! Vandaag maken we kennis, overlopen we de praktische afspraken en lichten we het eerste project toe: Parallax.
* We bekijken hoe je met dieptewerking, 2.5D camera's en kinetische typografie een statisch beeld omtovert in een levendige social media video.
* Vandaag overlopen we de briefing en specificaties; vanaf vrijdag starten we praktisch in de klas.
...
### 📌 Titel lesfiche
> **Motion 6CRM: Brainstorm, Bronmateriaal & Start Photoshop (Parallax)**
...
1. **Concept & Brainstorm:** Kies je thema (landschap, retro object, fashion, sciencefiction) en zoek 2 complementaire beelden in hoge resolutie via Pexels of Unsplash (een duidelijke voorgrond en een sfeervolle achtergrond).
...
### 📋 Organisatie of verloop
1. **Lesblok 1:** Zelfstandig zoeken en selecteren van beeldmateriaal. Goedkeuring concept door leerkracht.
2. **Lesblok 2:** Opzetten van de ordelijke projectmappen en Photoshop-canvas.
3. **Lesblok 3 & 4:** Vrijmaken van het hoofdonderwerp via Selecteren en maskeren / Laagmaskers. Individuele begeleiding bij complexe selecties (haar, randen).

## 📅 Les 3 07/09/2026 (2x Beeld)

### 📌 Titel lesfiche
> **Beeld 6CRM: Typografie, Kleurharmonisatie & Deadline Photoshop Ontwerp**
...
## 📅 Les 4 08/09/2026 (2x Motion)

### 📌 Titel lesfiche
> **Motion 6CRM: After Effects Opstart, 3D Lagen & Camera Parallax**
...
### 📋 Organisatie of verloop
1. **Lesblok 1:** Demonstratie: importeren van PSD in After Effects met behoud van laaggroottes en omzetten naar 3D-space.
2. **Lesblok 2:** Werken met *Two Views* (Top & Active Camera), Z-as transformaties en herschalen van de achtergrond.
3. **Lesblok 3 & 4:** Camera aanmaken, Position & Point of Interest animeren met keyframes. Toepassen van Easy Ease (`F9`).

## 📅 Les 5 11/09/2026 (2x Motion)

### 📌 Titel lesfiche
> **Motion 6CRM: Kinetische Typografie, Finetuning & Video Render**
...
### 📋 Organisatie of verloop
1. **Lesblok 1:** Demonstratie tekstanimatie en finetuning met de Graph Editor.
2. **Lesblok 2 & 3:** Zelfstandig afwerken van de animatie en instellen van Motion Blur.
3. **Lesblok 4:** Testrenders uitvoeren via Adobe Media Encoder, bitrate afstemmen op bestandsgrootte (< 5 MB) en bestandscontrole.

## 📅 Les 6 15/09/2026 (2x Motion)

### 📌 Titel lesfiche
> **Motion 6CRM: Deadline Parallax Oplevering & Screening**
